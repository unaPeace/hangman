...
// Function to handle selection of letter
...
for (let i = 97; i <= 122; i++) {
    ...
    button.setAttribute("data-letter", letter); // Set data attribute to identify the letter
    keyboardDiv.appendChild(button);
    button.addEventListener("click", (e) => selectLetter(e.target.getAttribute("data-letter")));
}
